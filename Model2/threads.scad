 ...
 *
 * Version 2.4.1 2021-01-28  Add thread depth and minor diameter utility functions (useful for ensuring wall thickness)
...
// ----------------------------------------------------------------------------
function thread_depth(pitch) = (5*sqrt(3)/8)*pitch;
function minor_dia(major_dia, pitch) = major_dia - (5*sqrt(3)/8)*pitch;

// ----------------------------------------------------------------------------
function segments_ (diameter) = min (72, max (ceil (diameter*6), 36));
function segments (diameter) = segments_(diameter)/($preview?6:1);
...
module metric_thread (diameter=8, pitch=1, length=1, internal=false, n_starts=1,
                      ...
                      angle=30, taper=0, leadin=0, leadfac=1.0, test=$test)
{
